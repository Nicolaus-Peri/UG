...
<!-- fullCalendar 2.2.5 -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/moment/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/AdminLTE/plugins/fullcalendar/main.js')); ?>"></script>
<!-- Select2 -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/select2/js/select2.full.min.js')); ?>"></script>
<!-- Bootstrap4 Duallistbox -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js')); ?>"></script>
<!-- InputMask -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/moment/moment.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/AdminLTE/plugins/inputmask/jquery.inputmask.min.js')); ?>"></script>
<!-- date-range-picker -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/daterangepicker/daterangepicker.js')); ?>"></script>
<!-- bootstrap color picker -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js')); ?>"></script>
<!-- Bootstrap Switch -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/bootstrap-switch/js/bootstrap-switch.min.js')); ?>"></script>
<!-- BS-Stepper -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/bs-stepper/js/bs-stepper.min.js')); ?>"></script>
<!-- dropzonejs -->
<script src="<?php echo e(asset('assets/AdminLTE/plugins/dropzone/min/dropzone.min.js')); ?>"></script>
...
<script type="text/javascript">
                        ...
                        datasets: [
                          {
                            ...
                            data                : <?php echo json_encode($member_arr, JSON_HEX_TAG); ?>
                          ...
                          },
                          {
                            ...
                            data                : <?php echo json_encode($visitor_arr, JSON_HEX_TAG); ?>
                  ...
                  </script><?php /**PATH C:\xampp\htdocs\undergroundblog\resources\views/layouts/backend-dashboard/javascript.blade.php ENDPATH**/ ?>