  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/fullcalendar/main.css')); ?>">
  <!-- daterange picker -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/daterangepicker/daterangepicker.css')); ?>">
  <!-- iCheck for checkboxes and radio inputs -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/icheck-bootstrap/icheck-bootstrap.min.css')); ?>">
  <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')); ?>">
  <!-- Tempusdominus Bootstrap 4 -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')); ?>">
  <!-- Select2 -->
  ...
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css')); ?>">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/bs-stepper/css/bs-stepper.min.css')); ?>">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/plugins/dropzone/min/dropzone.min.css')); ?>">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo e(asset('assets/AdminLTE/dist/css/adminlte.min.css')); ?>">
  <?php /**PATH C:\xampp\htdocs\undergroundblog\resources\views/layouts/backend-include/stylesheet.blade.php ENDPATH**/ ?>